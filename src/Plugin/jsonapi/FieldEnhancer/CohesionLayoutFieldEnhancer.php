...
#[ResourceFieldEnhancer(
  id: "cohesion_layout",
  label: new TranslatableMarkup("Cohesion Layout (Site Studio Layout Canvas field)"),
  description: new TranslatableMarkup("Formats a layout canvas JSON in consumable format."),
